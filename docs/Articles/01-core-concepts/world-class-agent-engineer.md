...
你是一名开发者。你在使用 Claude Code、Cursor、Windsurf 等 AI 编程工具，每天都在想自己是否已经把它们的潜力压榨到了极致。偶尔你会看到它们做些极其愚蠢的事情，你无法理解为什么外面有一群人似乎在建造虚拟火箭，而你却还在费力地做着最基础的工作。你以为问题出在你的框架、插件、配置或其他什么东西上。你使用了各种工具，你的 CLAUDE.md 文件长达两万六千行。然而无论你做什么，你都不明白为什么自己无法达到更高的境界，只能看着别人取得惊人的成果。

这就是你一直在等待的进阶指南。

另外我没有任何利益相关。当我说 CLAUDE.md 时我指的也是 AGENTS.md 或 .cursorrules，当我说 Claude Code 时也包括 Cursor、Windsurf、Aider 等工具。这些我都在大量使用。

过去几个月我最有趣的观察之一是，其实没有人真正知道如何最大限度地发挥 AI 编程助手的能力。似乎只有一小部分人能让它们发挥出极高的水平，而其他人都在挣扎，面对海量的工具陷入分析瘫痪，以为只要找到合适的依赖包、Skills 或框架组合就能解锁通用人工智能。
...
那么你该怎么做？我发现中性 prompt 很有效，即我不会让 AI 偏向某种结果。例如我不会说在数据库中给我找一个缺陷，相反我会说搜索数据库，尝试跟进每个组件的逻辑，并报告所有发现。像这样的中性 prompt 有时会发现缺陷，有时则会实事求是地说明代码是如何运行的，但它不会让 AI 产生代码中必然存在缺陷的偏见。
...
在与 AI 合作时你们会意识到的一个巨大陷阱是，有时它们看起来极为聪明，而在其他时候你简直不敢相信它们会犯如此低级的错误。主要的区别在于 AI 是否被迫做出任何假设或填补信息空白。到目前为止，它们在串联线索或做出假设方面仍然表现得极差。每当它们这样做时情况就会明显恶化。
...
最近 screenshot verification（屏幕截图验证）也成为任务的可行终点。你可以让 AI 实现某个功能直到所有测试通过，然后让它截取屏幕并在截图上验证设计或行为。这允许你让 AI 不断迭代并朝着你想要的设计努力。
...
你绝对希望不断向 AI 添加规则和 Skills，这就是你赋予它个性并记录偏好的方式。一旦你开始这样做，你的 AI 就会像魔法一样以你想要的方式做事。

随后你会看到性能再次开始恶化。这是因为随着你添加更多的规则和 Skills，它们开始相互矛盾，或者 AI 开始出现过度的上下文膨胀。你需要进行清理，整合规则和 Skills，并通过审查最新的偏好来消除矛盾。然后它又会恢复如魔法般的体验。保持简单，虔诚地留意它们的上下文和设计局限就是真正的秘密。
