      ...
      themeConfig: {
        nav: [
          ...
          },
          {
            text: 'Claude How To',
            items: [
              { text: '首页', link: '/claude-howto/' },
              { text: 'README', link: '/claude-howto/README.md' },
              { text: '目录索引', link: '/claude-howto/index-original.md' },
              { text: '功能目录', link: '/claude-howto/CATALOG.md' },
              { text: '学习路线图', link: '/claude-howto/LEARNING-ROADMAP.md' },
              { text: '概念指南', link: '/claude-howto/claude_concepts_guide.md' },
