      ...
      themeConfig: {
        nav: [
          ...
          },
          {
            text: 'Claude How To',
            items: [
              { text: '首页（中文翻译）', link: '/claude-howto/index-zh.md' },
              { text: '首页（英文原文）', link: '/claude-howto/' },
              { text: 'README（英文）', link: '/claude-howto/README.md' },
              { text: '目录索引（英文）', link: '/claude-howto/index-original.md' },
              { text: '功能目录（英文）', link: '/claude-howto/CATALOG.md' },
              { text: '学习路线图（英文）', link: '/claude-howto/LEARNING-ROADMAP.md' },
              { text: '概念指南（英文）', link: '/claude-howto/claude_concepts_guide.md' },
              { text: '---' },
              { text: '01. 斜杠命令', link: '/claude-howto/01-slash-commands/' },
              { text: '02. 记忆系统', link: '/claude-howto/02-memory/' },
              { text: '03. 技能系统', link: '/claude-howto/03-skills/' },
              { text: '04. 子代理', link: '/claude-howto/04-subagents/' },
              { text: '05. MCP 协议', link: '/claude-howto/05-mcp/' },
              { text: '06. 事件钩子', link: '/claude-howto/06-hooks/' },
              { text: '07. 插件系统', link: '/claude-howto/07-plugins/' },
              { text: '08. 检查点', link: '/claude-howto/08-checkpoints/' },
              { text: '09. 高级功能', link: '/claude-howto/09-advanced-features/' },
              { text: '10. 命令行界面', link: '/claude-howto/10-cli/' },
            ]
          },
          {
            text: '实践案例篇',
      ...
      themeConfig: {
        nav: [
          ...
          },
          {
            text: 'Claude How To',
            items: [
              { text: 'Home', link: '/claude-howto/' },
              { text: 'README', link: '/claude-howto/README.md' },
              { text: 'Index', link: '/claude-howto/index-original.md' },
              { text: 'Catalog', link: '/claude-howto/CATALOG.md' },
              { text: 'Learning Roadmap', link: '/claude-howto/LEARNING-ROADMAP.md' },
              { text: 'Concepts Guide', link: '/claude-howto/claude_concepts_guide.md' },
