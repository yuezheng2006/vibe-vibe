  ...
  themeConfig: {
    ...
    nav: [
...

      {
        ...
        items: [
          ...
          { text: '04-开发常识与技术栈', link: '/Advanced/04-dev-fundamentals/' },
          { text: '05-代码运行的三种状态与构建原理', link: '/Advanced/05-build-and-runtime-modes/' },
          { text: '06-界面与交互', link: '/Advanced/06-ui-ux/' },
          { text: '07-环境变量与安全机制', link: '/Advanced/07-env-vars-security/' },
          { text: '08-数据持久化与数据库', link: '/Advanced/08-data-persistence-database/' },
          { text: '09-功能测试流程与自动化脚本', link: '/Advanced/09-testing-automation/' },
          { text: '10-Localhost与公网访问', link: '/Advanced/10-localhost-public-access/' },
          { text: '11-Git版本控制与跨平台协作', link: '/Advanced/11-git-collaboration/' },
          { text: '12-无服务器部署与CI/CD自动化', link: '/Advanced/12-serverless-deploy-cicd/' },
          { text: '13-域名解析原理与网络接入', link: '/Advanced/13-domain-dns/' },
          { text: '14-云服务器运维与项目部署', link: '/Advanced/14-vps-ops-deploy/' },
    ...
    sidebar: generateSidebar({
      ...
      manualSortFileNameByPriority: [
        ...
        'Advanced/04-dev-fundamentals', 'Advanced/05-build-and-runtime-modes', 'Advanced/06-ui-ux',
        'Advanced/07-env-vars-security', 'Advanced/08-data-persistence-database', 'Advanced/09-testing-automation',
