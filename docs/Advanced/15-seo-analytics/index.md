...
你不知道每天到底有多少人来访问，用户来自哪里，用什么设备。 市面上的统计工具（如 Google Analytics）太重，而且容易侵犯隐私。老师傅想起了你第十四章刚刚搭好的 **1Panel 服务器**。
...
```
1. 15.1 Open Graph 与社交分享 (./01-opengraph.md) 🔴
   - Open Graph 协议基础
   - Next.js OG 配置方法
   - 设计优秀的 OG 图片
   - 不同平台优化策略
...
2. 15.2 SEO 全攻略 (./02-seo.md) 🔴
   - 搜索引擎工作原理
   - Metadata、Sitemap、Robots.txt 配置
   - 内容优化与 E-E-A-T 原则
   - 技术 SEO 与页面速度优化
   - 结构化数据与加速索引
   - 不同平台的优化策略

3. 15.3 Umami 统计部署 (./03-umami.md) 🟡
   - 为什么需要网站统计
   - 1Panel 一键部署 Umami
   - 核心指标解读
   - 主要指标 vs 虚荣指标
