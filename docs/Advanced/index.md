...
先搭台子，再唱戏。第1章带你从零搭建开发环境，理解代码是怎么跑起来的——从单文件HTML到现代模块化开发，从Terminal命令到Localhost端口，这些看似枯燥的基础，是你与AI协作的底气。第2章教你如何让AI更高效地为你工作，从Token经济学到VibeCoding工作流，掌握提示词心法和调试技巧。没有这些基础，后面的想法再好也落不了地。
...
| 章节 | 主题 | 状态 |
|---|---|---|
| 1 | [环境搭建与代码运行基础](/Advanced/01-environment-setup/) | ✅ 序言可阅读 |
| 2 | [AI 使用说明书](/Advanced/02-ai-tuning-guide/) | ✅ 序言可阅读 |
