...
**SSH认证**：老师傅推荐 **SSH认证**更安全方便，生成密钥对后，不需要每次输入密码。**【详见10.2节】** 会详细讲解 SSH 原理和配置步骤。
...
于是，**Pull Request（简称 PR）** 应运而生。PR 的字面意思是"拉取请求"，但更准确的理解是"合并请求"。

你可以把 PR 想象成一个"安检门"。当你在自己的分支上开发完功能后，不是直接合并，而是发起一个 PR，说："嘿，我开发了一个新功能，请你们检查一下代码，没问题再合并进去。"
