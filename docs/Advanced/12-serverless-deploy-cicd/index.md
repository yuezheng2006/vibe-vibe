...
1. [部署到 EdgeOne Pages](./01-deploy-edgeone.md) → 国内平台部署、环境变量配置
2. [部署到类 Vercel 平台](./02-deploy-vercel-platforms.md) → Vercel/Netlify/Railway/Render/ESA
3. [CI/CD 与自动化](./03-cicd-automation.md) → CNB 流水线、自动化配置
